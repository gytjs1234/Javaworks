 ...
 * 현재 class의 모든 method 에서 공통으로 공유할수 있다
 * 
 */
	int intKor = 0;
	int intEng = 0;
	...
	/*
	 * 두가지 알을 수행하는 method
	 * 1.class scope 에 선언된 변수에 값을 저장하고
	...
	public int scoreSum() {
		 ...
		 * 여기에 저장된 변수 값은 다른 method 에서
		 * 값을 변경(저장)하기 전에는 계속 유지하고있다.
		 * 현재프로젝트가 종료될때까지 유지하고있다
		 * 여기에 저장된 변수 값은 scorePrint()에서
		 * 읽어서 출력하면 같은 값이 출력된다.
		 */
