...
/*
 * scoreSum()에서 계산한 총점과
 * scoreSum()에서 출력한 과목점수와의 관계는 완전히 문제가 발생했다
 * 두 method 에 선언된 intKor,intKor,intEng,intMath는 이름은 같지만
 * 완전히 다른 변수(저장공간,값이 다른)이다
 * 
 * 총점을 scoreprint()에서 직접 계산하면 되겠지만
 * scoreSum()을 사용하여 총점을 계산하고 싶다
 * 이런함 누제를 해결하기 위하여 Go To ServiceV4
 * 
 * 
 * 
 */
	...
	public void scoreprint() {
		 ...
		 * 이미 준비되어 있다
		 * 다양한 method 를 사용하여 여러가지 가능을 손쉽게 사용할수 있다.
		 */
		String dLine = "=";
