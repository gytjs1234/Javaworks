...
public class StringEx1 {
	public static void main(String[] args) {
		...
		//배열은 length속성이고 문자열추출은 메서드다
		String strNo1 =strNation.substring(3); //3번이후의 문자를 잘라서 (0,1,2,3,4,5)
		System.out.println(strNo1);
		String strNo2 =strNation.substring(3,5); //부분문자열 자르기(일부문자열만 추출하고싶을때),3번에서 시작해서 5번에서자름
