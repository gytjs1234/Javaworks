...
//1~1000까지 범위중 임의 수 1개를 생성하여 intNum1 저장	
		...
		System.out.println("\tNum > num2" + (intNum1 > intNum2));
		System.out.println("\tNum < num2" + (intNum1 < intNum2));
		System.out.println("\tNum == num2" + (intNum1 == intNum2));
		/*
		 * 두개의 비교대상(intNum1,intNum2)에 담긴 값이 정확히 일치하지 않으면 true, 두개의 비교대상이 같지 않냐? 라고 묻는다
		 */
		System.out.println("\tNum <> num2" + (intNum1 != intNum2));
