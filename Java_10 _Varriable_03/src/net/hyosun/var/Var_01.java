...
public class Var_01 {
	...
	public static void main(String[] args) {
		...
		/*
		 * 명령문의 조합
		 * 명령문은 키워드1 키워드2 키워드2 처럼 빈칸으로 키워드를 구분 하거나 
		 * 키워드1.키워드2.키워드3 처럼(.)키워드를 구분하여 하나의 명령문을 구현(명령문을 문법에 맞게 완성)한다
		 *
		 *빈칸으로 조합된 키워드는 사용 용도에 따라 많은 경우의 수가 있다. Dot(.)로 조합된 키워드는
		 ...
		 *
		 */
		// metuod는 키워드()형태로 사용을 하며
		//다른 키워드와 조합으로 명령문을 완성한다
		//  ()안에 어떤값을 첨가하는데 이것을 아규먼트arguments  라고한다.
		//method 에 따라 args 가 잇거나 없거나 상관 없이 작동 되기도하고 없으면
		//문법 오류를 발생하기도 한다.
		//method 에 첨가되는 args 는 method 코드가 만들어질떄 정해진는 것으로 특별한 규칙이없다
